...
public class Lab {
	...
	public static final String COLLECTION_NAME_SHORT_FLAG = "-c";
	public static final String COLLECTION_NAME_LONG_FLAG = "--collection";

	public static final String DATABASE_NAME_SHORT_FLAG = "-db";
	public static final String DATABASE_NAME_LONG_FLAG = "--database";

	public static final String DATABASE_HOST_NAME_SHORT_FLAG = "-host";
	public static final String DATABASE_HOST_NAME_LONG_FLAG = "--host";
...
//		String format = CSV;
		...
		while (argv.hasNext()) {
			...
			case PORT_NAME_LONG_FLAG:
				...
				break;
			case COLLECTION_NAME_SHORT_FLAG:
			case COLLECTION_NAME_LONG_FLAG:
				collection = null;
				collection = nextArg(argv, flag).toLowerCase();
				break;
			case DATABASE_NAME_SHORT_FLAG:
			case DATABASE_NAME_LONG_FLAG:
				db = null;
				db = nextArg(argv, flag).toLowerCase();
				break;
			case DATABASE_HOST_NAME_SHORT_FLAG:
			case DATABASE_HOST_NAME_LONG_FLAG:
				host = null;
		...
		} else if (sink.equals(MONGODB)) {
			sensorEventsParam.setEventCollectorClassName("com.hortonworks.solution.MongoDBSensorEventCollector");
		}
